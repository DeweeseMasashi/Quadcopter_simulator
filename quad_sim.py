...
def TwoQuadTest():
    ...
    ctrl1 = controller.Controller_PID_Point2Point(quad_list[0].get_state,quad_manager.get_time,quad_list[0].set_motor_speeds,params=CONTROLLER_1_PARAMETERS)
    ctrl2 = controller.Controller_PID_Point2Point(quad_list[1].get_state,quad_manager.get_time,quad_list[1].set_motor_speeds,params=CONTROLLER_2_PARAMETERS)
